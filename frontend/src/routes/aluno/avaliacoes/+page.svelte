<script lang="ts">
    ...
    function handleSelfEvaluation() {
        // Redirecionar para o dialog de avaliação individual
        goto('/aluno/avaliacoes/individual');
    }
</script>

<div class="container" transition:fade={{ duration: 300 }}>
    <div class="header">
        <h1>Avaliações - Problema 1</h1>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                {#each paginatedAvaliacoes as avaliacao (avaliacao.id)}
                    <tr class="evaluation-row">
                        ...
                        <td class="text-right">
                            {#if avaliacao.enviada}
                                <div class="grade">{avaliacao.nota}</div>
